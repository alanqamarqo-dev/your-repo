"""Safe downloader for a Qwen-family model (fixed script).

Use this instead of the older download_qwen.py which contained characters
that caused Python to fail when running on Windows shells.
"""
...
if __name__ == '__main__':
    ...
    if isinstance(device_map, str) and device_map.lower() == 'cpu':
        device_map = {'': 'cpu'}
