...
def pytest_configure(config):
	...
	try:
		...
		# and enforce a 60s upper bound to avoid very long pytest collection.
		try:
			engines.bootstrap_register_all_engines(integration_registry, allow_optional=True, max_seconds=60)
		except TypeError:
			# In case an older Core_Engines implementation doesn't accept
			# max_seconds, fall back to the original call for compatibility.
