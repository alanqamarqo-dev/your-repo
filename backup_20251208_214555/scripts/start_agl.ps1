...
# Example persistent test env var: can be used to mark run-mode for tests (REAL env var)
# Set to '1' to enable malaria test marker for local sessions
$env:AGL_TEST_ENV_MALARIA = '1'
