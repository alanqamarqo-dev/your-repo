...
AGL Security — MongoDB Database Layer

طبقة قاعدة البيانات — MongoDB
...
Environment variables:
  ...
  AGL_MONGO_URI  — connection string  (default: mongodb://localhost:27017)

  AGL_MONGO_DB   — database name      (default: agl_security)
...
#  Document Wrapper — attribute access like SQLAlchemy models
...
#  Migration helper: SQLite → MongoDB
...
def migrate_from_sqlite():
    ...
    try:
        ...
        print(f"✅ Migration complete: {user_count} users, {scan_count} scans")
